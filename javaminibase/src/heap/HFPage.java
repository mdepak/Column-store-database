...
public class HFPage extends Page
  ...
  */
   ...
   * @throws IOException I/O errors in C++ Status firstRecord(RID& firstRid)
   */
   ...
   * @throws IOException I/O errors in C++ Status nextRecord (RID curRid, RID& nextRid)
   */
  ...
  /**
   * returns a tuple in a byte array[pageSize] with given RID rid. <br> in C++	Status
   * returnRecord(RID rid, char*& recPtr, int& recLen)
   *
   * @param rid the record ID
