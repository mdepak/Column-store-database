 ...
 * space-efficient manner.  That is, the packaged result contains the key followed immediately by
 * the data value; No padding bytes are used (not even for alignment).
 *
...
public class BT implements GlobalConst {
   ...
   * @throws NodeNotMatchException pageType is neither NodeType.LEAF nor NodeType.INDEX.
   */
   ...
   * @throws KeyNotMatchException key is neither StringKey nor  IntegerKey
   * @throws NodeNotMatchException nodeType is neither NodeType.LEAF nor NodeType.INDEX.
