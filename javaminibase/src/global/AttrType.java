...
public class AttrType {
  ...
  /**
   * AttrType Constructor <br> An attribute type of String can be defined as <ul> <li>   AttrType
   * attrType = new AttrType(AttrType.attrString); </ul> and subsequently used as <ul> <li>   if
   * (attrType.attrType == AttrType.attrString) .... </ul>
   *
