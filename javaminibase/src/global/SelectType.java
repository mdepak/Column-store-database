...
public class SelectType {
  ...
  /**
   * SelectType Constructor <br> A selected type can be defined as <ul> <li>   SelectType selectType
   * = new SelectType(SelectType.SelBoth); </ul> and subsequently used as <ul> <li>   if
   * (selectType.selectType == SelectType.SelBoth) .... </ul>
   *
