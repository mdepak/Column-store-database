...
public class IndexType {
  ...
  /**
   * IndexType Constructor <br> An index type can be defined as <ul> <li>   IndexType indexType =
   * new IndexType(IndexType.Hash); </ul> and subsequently used as <ul> <li>   if
   * (indexType.indexType == IndexType.Hash) .... </ul>
   *
