...
public class AttrOperator {
  ...
  /**
   * AttrOperator Constructor <br> An attribute operator types can be defined as <ul> <li>
   * AttrOperator attrOperator = new AttrOperator(AttrOperator.aopEQ); </ul> and subsequently used
   * as <ul> <li>   if (attrOperator.attrOperator == AttrOperator.aopEQ) .... </ul>
   *
